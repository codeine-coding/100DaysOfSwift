...
class ViewController: UIViewController, WKNavigationDelegate {
    ...
    override func viewDidLoad() {
        ...
        let goBackBtn = UIBarButtonItem(title: "<", style: .plain, target: self, action: #selector(goBack))
        let goForwardBtn = UIBarButtonItem(title: ">", style: .plain,  target: self, action: #selector(goForward))
        
        toolbarItems = [goBackBtn, spacer, goForwardBtn, spacer2, progressButton, spacer3, refresh]
